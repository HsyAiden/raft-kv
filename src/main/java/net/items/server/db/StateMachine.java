...
import static net.items.server.constant.CommandType.DELETE;
import static net.items.server.constant.CommandType.PUT;
...
public class StateMachine {
    ...
    private StateMachine() {
        ...
        if (success) {
            log.info("make a new dir : " + stateMachineDir);
        }
